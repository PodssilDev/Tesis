...
calcula_distancia_correlacion <- function(
    archivo_sfa = "Resultados/Eficiencia/Eficiencias_SFA_2014-2023.xlsx",
    archivo_dea = paste0("data/Osswald/", archivo_dea_global),
    sheet_sfa = 1,
    sheet_dea = 1,
    anios = 2014:2023,
    output = archivo_salida_global
) {
  # -------------------------------
...
# ---------------------------------------------------
# Compara eficiencias SFA vs DEA y genera archivo Excel
# con resultados por complejidad y globales por año.
res <- invisible(calcula_distancia_correlacion(
  archivo_sfa = "Resultados/Eficiencia/Eficiencias_SFA_2014-2023.xlsx",
  archivo_dea = paste0("data/osswald/", archivo_dea_global),
  output      = archivo_salida_global
))
...
graficar_correlacion_y_distancia <- function(archivo_resultados = archivo_salida_global) {
  ...
  ggsave("Resultados/Comparacion/Correlacion_SFA_DEA.png", plot = grafico_cor, width = 8, height = 5, dpi = 300)
  ...
  ggsave("Resultados/Comparacion/Distancia_Euclidiana_SFA_DEA.png", plot = grafico_dist, width = 8, height = 5, dpi = 300)
...
graficar_correlacion_y_distancia(archivo_salida_global)
