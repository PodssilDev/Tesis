...
ggsave("Resultados/Eficiencia/violinplot_eficiencia.png", width = 15, height = 5, dpi = 300)
...
ggsave("Resultados/Eficiencia/violinplot_eficiencia_complejidad.png", width = 15, height = 5, dpi = 300)
